...
$(document).ready(function () {
  ...
  function getData(param) {
    $.get('/get-forms', function (data, textStatus, jqXHR) {
      ...
      for (var _i = 0, _Object$entries = Object.entries(data); _i < _Object$entries.length; _i++) {
        ...
        $('.form-list').append("<a href=\"#\" class=\"list-group-item list-group-item-action\" id=\"list-group-item-action\" data-id=".concat(value.id, ">\n                    ").concat(value.title, "\n                </a>"));
      }
    });
  }
  ...
  function postData() {
    var requestURL = $('.id').val() === '0' ? '/save-form' : '/update-form/' + $('.id').val();
    ...
    var result = $.post(requestURL, formData);
